        ...
        GetConfigurationQuery request, CancellationToken cancellationToken)
    {
        ...
        switch (request.Level)
        {
            case ConfigurationLevel.All:
                ...
                var allUserEnvVariables = Environment.GetEnvironmentVariables(
                ...
                var allMachineEnvVariables = Environment.GetEnvironmentVariables(
            ...
            case ConfigurationLevel.Admin:
                ...
                {
                    result.Add(secret.ToString(),
                        await SecretsHelper.GetSecretAsync(secret));
                }
                break;
        }
